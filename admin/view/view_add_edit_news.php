	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div class="row" style="margin:5px">
				...
				<div class="col-md-10">
					<input type="checkbox" <?php echo isset($arr["c_name"])&& $arr["c_hotnews"]==1?"checked":""; ?>
                           name="c_hotnews" id="hot_news"> <label for="hot_news">Hot news</label>
				</div>
			</div>			
			<!-- end row -->
			...
			<div class="row" style="margin:5px">
				...
				<div class="col-md-10">
					<textarea style="width:700px;height:100px;" name="c_content"> <?php echo isset($arr["c_content"]) ? $arr["c_content"] : ""; ?>
					</textarea>
			...
			<div class="row" style="margin:5px">
				...
				<div class="col-md-10">
					...
					<div style="margin-top:5px;">
                        <?php
                            if(isset($arr["c_img"])&&file_exists("../public/upload/news/".$arr["c_img"])){
                        ?>
						<img src="<?php echo "../public/upload/news/".$arr["c_img"]; ?>" style="width:100px;">
                        <?php }?>
					</div>
				</div>
			</div>			
